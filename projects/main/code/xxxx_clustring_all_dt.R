...
imerg_dt <- readRDS("./projects/main/data/hourly_mean_imergf_glob_LST_2001_20.rds")

mean_dat <- imerg_dt[, .(lat, lon, hour = factor(hour(time_lst)), value = prec_mean)]
...
cw.gap<-clusGap(mean_dat_wide_comp,FUN=kmeans,K.max=10,B=3,d.power=2)
...
ggsave("./projects/main/results/02e_imerg_clusters_mean_cmorph_2001_20_n50.png", width = 9.5, height = 5.3, 
       units = "in", dpi = 600)
...
ggsave("./projects/main/results/02e_imerg_clusters_mean_line_cmorph_2001_20_n50.png", width = 10.5, height = 5.3, 
       units = "in", dpi = 600)
...
ggsave("./projects/main/results/02e_imerg_clusters_mean_spat_cmorph_2001_20_n50.png", width = 9.9, height = 4.6, 
       units = "in", dpi = 600)
