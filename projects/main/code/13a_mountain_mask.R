...
saveRDS(masked_data_list2, "./projects/main/data/mountain_mean_hour_all_dt_2001_20.RDS")
...
mean_24h_mount <- mount_data_dt[, .(mean_value = mean(prec_mean, na.rm = TRUE)), by = .(hour(time_lst), name.x, name.y, region)]
...
ggsave("./projects/main/results/13a_mount_na_24hlineplot_mean_after.png",
...
ggsave("./projects/main/results/13a_mount_sa_24hlineplot_mean_after.png",
       width = 10.6, height = 5.2, units = "in", dpi = 600)
...
ggsave("./projects/main/results/13a_mount_europ_24hlineplot_mean_after.png",
       width = 10.6, height = 5.2, units = "in", dpi = 600)
...
ggsave("./projects/main/results/13a_mount_asia_24hlineplot_mean_after.png",
       width = 10.6, height = 5.2, units = "in", dpi = 600)
...
ggsave("./projects/main/results/13a_mount_africa_24hlineplot_mean_after.png",
       width = 10.6, height = 5.2, units = "in", dpi = 600)
