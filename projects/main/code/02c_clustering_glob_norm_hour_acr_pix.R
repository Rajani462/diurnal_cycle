...
mean_dat[, normalized_value2 := scale(normalized_value, center = TRUE, scale = FALSE), by = .(lat, lon)]
...
ggsave("./projects/main/results/02c_clusters_mean_cmorph_2001_20_n50.png", width = 9.5, height = 5.3, 
       units = "in", dpi = 600)
...
ggsave("./projects/main/results/02c_clusters_mean_line_cmorph_2001_20_n50.png", width = 10.5, height = 5.3, 
       units = "in", dpi = 600)
...
ggsave("./projects/main/results/02c_clusters_mean_spat_cmorph_2001_20_n50.png", width = 9.9, height = 4.6, 
       units = "in", dpi = 600)
