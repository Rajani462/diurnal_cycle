...
#cmorph_dt <- readRDS("./projects/main/data/hourly_mean_cmorphf_glob_LST_2001_20.rds")
...
ggsave("./projects/main/results/02e_cmorph_clusters_mean_line_cmorph_2001_20_n50.png", width = 10.5, height = 5.3, 
       units = "in", dpi = 600)
