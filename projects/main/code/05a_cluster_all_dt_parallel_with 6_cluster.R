...
cluster_data <- function(data_dt, k_value = 6, nstart_value = 50) {
...
saveRDS(processed_data_list, "./projects/main/data/cluster_6_all_dat_parellel_setseed123.RDS")
...
ggsave("./projects/main/results/cluster/05b_all_data_cluster_6_line_plot.png", width = 9.5, height = 5.3, 
       units = "in", dpi = 600)
