...
all_dt <- readRDS("./projects/main/data/hourly_mean_all_datasets_glob_LST_2001_20.rds")
era5 <- all_dt$era5

mean_dat <- era5[, .(lat = y, lon = x, hour = factor(hour(time_lst)), value = prec_mean)]
...
mean_dat <- era5_dt[, .(lat, lon, hour = factor(hour(time_lst)), value = prec_mean)]
mean_dat[, normalized_value := scale(value, center = TRUE, scale = TRUE), by = .(lat, lon)]
...
ggsave("./projects/main/results/02e_era5_clusters_mean_cmorph_2001_20_n50.png", width = 9.5, height = 5.3, 
       units = "in", dpi = 600)
...
ggsave("./projects/main/results/02e_era5_clusters_mean_line_cmorph_2001_20_n50.png", width = 10.5, height = 5.3, 
       units = "in", dpi = 600)
...
ggsave("./projects/main/results/02e_era5_clusters_mean_spat_cmorph_2001_20_n50.png", width = 9.9, height = 4.6, 
       units = "in", dpi = 600)
