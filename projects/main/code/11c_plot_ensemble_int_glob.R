...
# hist(to_plot2[value >= -20 | value <= 20])
to_plot2[value > 2]
to_plot2[value < -3]
...
ggplot() +
  ...
  scale_fill_gradientn(colors = brewer.pal(11, "BrBG"), 
                       #breaks = c(-0.20, -0.15, -0.10, -0.05, 0, 0.05, 0.10, 0.15, 0.20), 
...
ggsave("./projects/main/results/11c_ens_mean_diff_spat_int.png", width = 10.5, height = 5.1,
       units = "in", dpi = 600)
...
ggsave("./projects/main/results/11_ens_mean_diff_spat_int2.png", width = 10.5, height = 5.1,
       units = "in", dpi = 600)
