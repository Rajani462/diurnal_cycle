...
# Define the file paths for multiple datasets
file_paths <- c(
  "./projects/main/data/hourly_int_imergf_glob_2001_20_fliptrans.nc",
  "./projects/main/data/hourly_int_gsmap_glob_2015_20_fliptrans.nc", 
  "./projects/main/data/hourly_int_cmorph_glob_2001_20.nc", 
  "./projects/main/data/hourly_int_persiann_glob_2001_20.nc", 
  "./projects/main/data/hourly_int_era5_glob_2001_20.nc"
...
saveRDS(dat_lst_list, "./projects/main/data/hourly_int_all_datasets_LST_glob_2001_20.rds")