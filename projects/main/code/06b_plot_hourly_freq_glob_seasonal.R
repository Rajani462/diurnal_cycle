...
mean_data_list <- lapply(data_list, function(df) df[, .(mean_value = round(mean(prec_freq, na.rm = FALSE), 2)), by = .(lat, lon, season, name)])
...
ggsave("./projects/main/results/06b_spat_freq_seasonal.png", width = 11.5, height = 5.3, 
       units = "in", dpi = 600)
...
ggsave("./projects/main/results/06b_24hlineplot_freq_glob_seasonal.png",
       width = 8.9, height = 5.6, units = "in", dpi = 600)


## for land, ocean and Global

mean_24h_landocn <- data_dt[, .(mean_value = mean(prec_freq, na.rm = TRUE)), by = .(hour(time_lst), name, location, season)]
...
ggsave("./projects/main/results/06b_24hlineplot_freq_landocnglob_seasonal.png",
       width = 8.6, height = 6.3, units = "in", dpi = 600)


### Estimate the peak hour of data.tables -------------------------------------------

system.time(peak_hour_dt <- data_dt[, .SD[which.max(prec_freq)], by = .(lat, lon, name, season)])
# user  system elapsed 
...
ggsave("./projects/main/results/06b_plot_spat_peak_hour_freq_seasonal_JJA.png", width = 10.5, height = 6.9, 
       units = "in", dpi = 600)
...
ggsave("./projects/main/results/06b_plot_spat_peak_hour_freq_seasonal_DJF.png", width = 10.5, height = 6.9, 
       units = "in", dpi = 600)
...
ggsave("./projects/main/results/06b_plot_spat_peak_hour_freq_seasonal_clasfy_JJA.png", width = 10.5, height = 6.9, 
       units = "in", dpi = 600)
...
ggsave("./projects/main/results/06b_plot_spat_peak_hour_freq_seasonal_clasfy_DJF.png", width = 10.5, height = 6.9, 
       units = "in", dpi = 600)
