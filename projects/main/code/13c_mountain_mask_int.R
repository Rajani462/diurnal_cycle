...
saveRDS(masked_data_list2, "./projects/main/data/mountain_int_hour_all_dt_2001_20.RDS")
...
mean_24h_mount <- mount_data_dt[, .(mean_value = mean(prec_int, na.rm = TRUE)), by = .(hour(time_lst), name.x, name.y, region)]
...
ggplot(north_amric, aes(hour, mean_value, col = name.x, group = name.x)) + 
  ...
  geom_line() + 
  facet_wrap(~name.y, scales = "free_y") + 
  labs(x ="Hour (LST)", y = "int (mm/hr)", fill = "") + 
  theme_generic

ggsave("./projects/main/results/13c_mount_na_24hlineplot_int.png",
...
ggsave("./projects/main/results/13c_mount_sa_24hlineplot_int.png",
       width = 10.6, height = 5.2, units = "in", dpi = 600)
...
ggsave("./projects/main/results/13c_mount_europ_24hlineplot_int.png",
       width = 10.6, height = 5.2, units = "in", dpi = 600)
...
ggsave("./projects/main/results/13c_mount_asia_24hlineplot_int.png",
       width = 10.6, height = 5.2, units = "in", dpi = 600)
...
ggsave("./projects/main/results/13c_mount_africa_24hlineplot_int.png",
       width = 10.6, height = 5.2, units = "in", dpi = 600)
