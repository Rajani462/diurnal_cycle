...
data_list <- readRDS("./projects/main/reproduce/data/hourly_int_all_datasets_LST_glob_2001_20.rds")
...
ggsave("~/rajani/diurnal_cycle/projects/main/reproduce/results/03_fig_spat_int.png", width = 10.5, height = 5.1, 
       units = "in", dpi = 600)
