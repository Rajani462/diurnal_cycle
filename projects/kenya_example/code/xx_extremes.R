...
#extreme hourly precipitation values for each grid and hour

cdo hourpctl,90 cmorph_hour_kenya_2001_20.nc -hourmin cmorph_hour_kenya_2001_20.nc -hourmax cmorph_hour_kenya_2001_20.nc ~/rajani/diurnal_cycle/projects/kenya_example/data/output/cmorph_hourly_90_perc_2001_20_kenya.nc

cmorph_90p <- brick("./projects/kenya_example/data/output/cmorph_hourly_90_perc_2001_20_kenya.nc")
...
## In R using rasyter
# Function to calculate the 99th percentile
percentile_99 <- function(x) {
  quantile(x, probs = 0.99, na.rm = TRUE)
}

# Calculate the 99th percentile for each grid cell and each year
percentile_99_raster <- calc(cmorph, percentile_99)

# Print the calculated raster
print(percentile_99_raster)

# Save the result as a raster file if needed
# Replace 'output_file.nc' with your desired output file name and format
writeRaster(percentile_99_raster, filename = "output_file.nc", format = "CDF")




#cdo fldpctl,99 ~/rajani/diurnal_cycle/projects/kenya_example/data/cmorph_hour_kenya_2001_20.nc ~/rajani/diurnal_cycle/projects/kenya_example/data/output/cmorph_99_perc_2001_20_kenya.nc

#if there is missing values
cdo -timpctl,99 -setmissval,-9999.9 cmorph_hour_kenya_2001_20.nc -timmin -setmissval,-9999.9 cmorph_hour_kenya_2001_20.nc -timmax -setmissval,-9999.9 cmorph_hour_kenya_2001_20.nc cmorph_99_perc_2001_20_kenya.nc

#if there is no missing values
cdo -timpctl,99 cmorph_hour_kenya_2001_20.nc -timmin cmorph_hour_kenya_2001_20.nc -timmax cmorph_hour_kenya_2001_20.nc cmorph_99_perc_2001_20_kenya.nc
cdo -timpctl,99 imerg_f_hour_kenya_2001_20.nc -timmin imerg_f_hour_kenya_2001_20.nc -timmax imerg_f_hour_kenya_2001_20.nc imerg_99_perc_2001_20_kenya.nc
cdo -timpctl,99 imerg_f_hour_kenya_2001_20_grid_025.nc -timmin imerg_f_hour_kenya_2001_20_grid_025.nc -timmax imerg_f_hour_kenya_2001_20_grid_025.nc imerg_99_perc_2001_20_kenya_grid_025.nc

#for 60 NS 
cd ~/rajani/diurnal_cycle/projects/kenya_example/data

cdo -b 32 -P 50 -timpctl,99 ~/shared/data_projects/diurnal_precip/input_data/imerg_tp_mm_60ns_2001_20_025_hourly.nc -timmin ~/shared/data_projects/diurnal_precip/input_data/imerg_tp_mm_60ns_2001_20_025_hourly.nc -timmax ~/shared/data_projects/diurnal_precip/input_data/imerg_tp_mm_60ns_2001_20_025_hourly.nc imerg_99_perc_2001_20_60ns_grid_025.nc
~/shared/data_projects/diurnal_precip/input_data

#daily
cdo -b 32 -P 50 -daysum ~/shared/data_projects/diurnal_precip/input_data/imerg_tp_mm_60ns_2001_20_025_hourly.nc imerg_tp_mm_60ns_2001_20_025_daily.nc
cdo -timpctl,99 -setmissval,-9999.9 imerg_tp_mm_60ns_2001_20_025_daily.nc -timmin -setmissval,-9999.9 imerg_tp_mm_60ns_2001_20_025_daily.nc -timmax -setmissval,-9999.9 imerg_tp_mm_60ns_2001_20_025_daily.nc daily_imerg_99_perc_2001_20_60ns_grid_025.nc



cdo -b 32 -P 50 -daysum -timpctl,99 \
~/shared/data_projects/diurnal_precip/input_data/imerg_tp_mm_60ns_2001_20_025_hourly.nc \
-daymin -timmin \
~/shared/data_projects/diurnal_precip/input_data/imerg_tp_mm_60ns_2001_20_025_hourly.nc \
-daymax -timmax \
~/shared/data_projects/diurnal_precip/input_data/imerg_tp_mm_60ns_2001_20_025_hourly.nc \
daily_imerg_99_perc_2001_20_60ns_grid_025.nc


cmorph_99p <- rast("./projects/kenya_example/data/output/cmorph_99_perc_2001_20_kenya.nc")
cmorph_99p <- raster("./projects/kenya_example/data/output/cmorph_99_perc_2001_20_kenya.nc")
imerg_99p <- raster("./projects/kenya_example/data/output/cmorph_99_perc_2001_20_kenya.nc")


daily_imerg_99p <- raster("./projects/kenya_example/data/daily_imerg_99_perc_2001_20_60ns_grid_025.nc")
plot(daily_imerg_99p)

#for th enetire region (i.e., Kenya over here)
cdo -fldpctl,99 cmorph_hour_kenya_2001_20.nc -timmin cmorph_hour_kenya_2001_20.nc -timmax cmorph_hour_kenya_2001_20.nc cmorph_99_perc_2001_20_kenya_region.nc


cdo timavg cmorph_hour_kenya_2001_20.nc cmorph_timavg_2001_20_kenya.nc
cmorph_timavg <- raster("./projects/kenya_example/data/cmorph_timavg_2001_20_kenya.nc")


cdo fldpctl,99 cmorph_timavg_2001_20_kenya.nc cmorph_99_perc_2001_20_kenya_region.nc

cmorph_timavg_99_perc <- raster("./projects/kenya_example/data/cmorph_99_perc_2001_20_kenya_region.nc")
